...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { code: @code.code, ipaddress: @code.ipaddress, language: @code.language, name: @code.name }
    end
  ...
  test "should update code" do
    patch :update, id: @code, code: { code: @code.code, ipaddress: @code.ipaddress, language: @code.language, name: @code.name }
    assert_redirected_to code_path(assigns(:code))
  end
